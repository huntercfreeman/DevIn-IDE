...
public class CommonBackgroundTaskApi : IBackgroundTaskGroup
{
    ...
    private readonly DevInCommonConfig _commonConfig;
    ...
    public CommonBackgroundTaskApi(
        ...
        DevInCommonConfig commonConfig,
        IJSRuntime jsRuntime)
    {
        ...
        JsRuntimeCommonApi = jsRuntime.GetDevInCommonApi();

        _treeViewService.CommonBackgroundTaskApi = this;
    }

    public DevInCommonJavaScriptInteropApi JsRuntimeCommonApi { get; }
    ...
    private async ValueTask Do_DevInCommonInitializer(Key<ContextSwitchGroup> contextSwitchGroupKey)
    {
    ...
    public ValueTask HandleEvent()
	{
		...
		{
			case CommonWorkKind.DevInCommonInitializerWork:
				return Do_DevInCommonInitializer(DevInCommonInitializer.ContextSwitchGroupKey);

...
/// </summary>
public static class DevInDebugSomething
{
	#if DEBUG
	...
	public static int GetterOrSetterNode { get; set; }
	...
	public static string CreateText()
	{
		...
		var nodeCountList = new List<(string NodeName, int NodeCount)>
		{
			...
			("GetterOrSetterNode", GetterOrSetterNode),
		...
		#else
		builder.AppendLine($"Run with 'DEBUG' mode to see output from '{nameof(DevInDebugSomething)}'.");
		#endif

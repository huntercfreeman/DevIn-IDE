...
namespace DevIn.Common.RazorLib.UnitTesting;

public class CommonUnitTestHelper
{
    /// <summary>
    /// To create an instance of <see cref="CommonUnitTestHelper"/>,
    /// one should invoke <see cref="AddDevInCommonServicesUnitTesting(IServiceCollection, DevInHostingInformation)"/>,
    ...
    public static IServiceCollection AddDevInCommonServicesUnitTesting(
    ...
    {
        throw new DevInCommonException(

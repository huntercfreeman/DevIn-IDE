...
public class TreeViewEnumerable : TreeViewWithType<WatchWindowObject>
{
    ...
    public override Task LoadChildListAsync()
    {
        ...
        try
        {
            ...
            {
                throw new DevInCommonException($"Unexpected failed cast to the Type {nameof(IEnumerable)}. {nameof(TreeViewEnumerable)} are to have a {nameof(Item.Item)} which is castable as {nameof(IEnumerable)}");
            }

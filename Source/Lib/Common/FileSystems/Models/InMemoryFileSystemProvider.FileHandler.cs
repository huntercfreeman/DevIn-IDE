    ...
    public class InMemoryFileHandler : IFileHandler
    {
            ...
            CancellationToken cancellationToken = default)
        {
            // Source
            {
                ...
                if (indexOfSource == -1)
                    throw new DevInCommonException($"Source file: {sourceAbsolutePathString} was not found.");
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (existingFile.Data is null)
            	throw new DevInCommonException($"File with path: '{absolutePathString}' was not found.");

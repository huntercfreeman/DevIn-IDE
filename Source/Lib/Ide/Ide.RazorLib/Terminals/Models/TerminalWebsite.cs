...
using DevIn.Ide.RazorLib.Exceptions;
using DevIn.Ide.RazorLib.Terminals.Models.Internals;
...
public class TerminalWebsite : ITerminal, IBackgroundTaskGroup
{
	...
	*/
		...
		CancellationToken cancellationToken)
	{
		...
		throw new DevInIdeException($"The method '{nameof(DotNetWebsiteCliAsync)}' should return on each branch of the switch statement.");
	}

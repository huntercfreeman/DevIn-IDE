...
using DevIn.Common.RazorLib.FileSystems.Displays;
...
using DevIn.Ide.RazorLib.FolderExplorers.Displays;
using DevIn.Ide.RazorLib.Terminals.Displays;
...
public class IdeBackgroundTaskApi : IBackgroundTaskGroup
{
    ...
    public ValueTask Do_DevInIdeInitializerOnInit()
    {
        ...
        List<InputFilePattern> inputFilePatternsList)
    {
        ...
        var inputFileDialog = new DialogViewModel(
            ...
            null,
            DevIn.Ide.RazorLib.Htmls.Models.HtmlFacts.Classes.DIALOG_PADDING_0,
            true,
            null);
    ...
    public ValueTask HandleEvent()
    {
        ...
        {
            case IdeBackgroundTaskApiWorkKind.DevInIdeInitializerOnInit:
                return Do_DevInIdeInitializerOnInit();

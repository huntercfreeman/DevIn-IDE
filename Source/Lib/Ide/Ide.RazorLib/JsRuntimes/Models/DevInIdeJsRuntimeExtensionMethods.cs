...
/// </remarks>
public static class DevInIdeJsRuntimeExtensionMethods
{
    public static DevInIdeJavaScriptInteropApi GetDevInIdeApi(this IJSRuntime jsRuntime)
    {
        return new DevInIdeJavaScriptInteropApi(jsRuntime);
    }
}
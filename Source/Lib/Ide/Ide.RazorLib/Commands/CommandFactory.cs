...
using DevIn.Ide.RazorLib.CodeSearches.Displays;
...
public class CommandFactory : ICommandFactory
{
		...
		// Add command to bring up a Context Switch dialog. Example: { Ctrl + Tab }
		{
			...
			var openContextSwitchDialogCommand = new CommonCommand(
	            ...
	            async commandArgs =>
				{
			        ...
			        {
			        	_contextService.GetContextSwitchState().FocusInitiallyContextSwitchGroupKey = DevInTextEditorInitializer.ContextSwitchGroupKey;
			        }
			        else
			        {
			        	_contextService.GetContextSwitchState().FocusInitiallyContextSwitchGroupKey = DevInCommonInitializer.ContextSwitchGroupKey;
			        }
			...
			var openCommandBarCommand = new CommonCommand(
	            ...
	            commandArgs =>
				{
                    _commandBarWidget ??= new WidgetModel(
                        typeof(DevIn.Ide.RazorLib.CommandBars.Displays.CommandBarDisplay),
                        componentParameterMap: null,
                        cssClass: null,
    	...
    	CursorModifierBagTextEditor cursorModifierBag)
    {
        ...
        var findAllReferencesPanel = new Panel(
            "Find All References",
            DevIn.Ide.RazorLib.FindAllReferences.Displays.FindAllReferencesDisplay.FindAllReferencesPanelKey,
            DevIn.Ide.RazorLib.FindAllReferences.Displays.FindAllReferencesDisplay.FindAllReferencesDynamicViewModelKey,
            ContextFacts.FindAllReferencesContext.ContextKey,
            typeof(DevIn.Ide.RazorLib.FindAllReferences.Displays.FindAllReferencesDisplay),
            null,
            _panelService,
            _dialogService,

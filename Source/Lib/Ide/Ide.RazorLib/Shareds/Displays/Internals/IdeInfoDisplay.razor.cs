...
//             I'm thinking that when publishing the DevIn.Ide.Photino.csproj,
...
//             flag that was used to publish the 'DevIn.Ide.Photino.csproj' project itself.
...
// ==========================================================================================================
//
// I ran the 'DevIn.Ide.Photino.csproj' various ways while using the
...
// "DevIn", and write out if that specific assembly has
// the debug attribute.
// 

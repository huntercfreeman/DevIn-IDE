...
public sealed class TextEditorService
{
		...
		IServiceProvider serviceProvider)
    {
		...
		JsRuntimeTextEditorApi = _jsRuntime.GetDevInTextEditorApi();
	...
	public DevInTextEditorJavaScriptInteropApi JsRuntimeTextEditorApi { get; }
	public DevInCommonJavaScriptInteropApi JsRuntimeCommonApi => _commonBackgroundTaskApi.JsRuntimeCommonApi;
	public IAutocompleteIndexer AutocompleteIndexer { get; }
	public IAutocompleteService AutocompleteService { get; }
	public DevInTextEditorConfig TextEditorConfig { get; }
    ...
    public void Enqueue_TextEditorInitializationBackgroundTaskGroupWorkKind()
    {
    	_backgroundTaskService.Continuous_EnqueueGroup(new BackgroundTask(
    		...
    		Do_DevInTextEditorInitializerOnInit));
    }

    public async ValueTask Do_DevInTextEditorInitializerOnInit()
    {
        ...
        _contextService.RegisterContextSwitchGroup(
            new ContextSwitchGroup(
                DevIn.TextEditor.RazorLib.Installations.Displays.DevInTextEditorInitializer.ContextSwitchGroupKey,
                "Text Editor",
                () =>
                {
        ...
        _keymapService.RegisterKeymapLayer(DevIn.TextEditor.RazorLib.Keymaps.Models.Defaults.TextEditorKeymapDefaultFacts.HasSelectionLayer);
    }
}

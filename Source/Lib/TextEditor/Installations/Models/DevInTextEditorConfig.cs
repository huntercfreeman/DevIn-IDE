...
/// </remarks>
public record DevInTextEditorConfig
{
    /// <summary>
    /// The initial theme for the text editor is NOT the same as <see cref="DevInCommonConfig.InitialThemeKey"/>.
    ...
    /// </summary>
    public List<ThemeRecord>? CustomThemeRecordList { get; init; } = DevInTextEditorCustomThemeFacts.AllCustomThemesList;
    /// <summary>
    ...
    /// made into a <see cref="DevIn.TextEditor.RazorLib.Lexers.Models.ResourceUri"/>.
    ///
    ...
    /// 
    /// If one wishes to configure DevIn.Common themselves, then set this to false, and invoke
    /// <see cref="Common.RazorLib.Installations.Models.ServiceCollectionExtensions.AddDevInCommonServices(IServiceCollection, DevInHostingInformation, Func{DevInCommonConfig, DevInCommonConfig}?)"/>
    /// prior to invoking DevIn.TextEditor's
    /// </summary>
    public bool AddDevInCommon { get; init; } = true;
}
...
using DevIn.Common.RazorLib.Icons.Displays;
...
public sealed partial class TextEditorViewModelSlimDisplay : ComponentBase, IDisposable
{
    ...
    [Inject]
    public IDevInTextEditorComponentRenderers TextEditorComponentRenderers { get; set; } = null!;
    [Inject]
    ...
    [Inject]
    public DevInTextEditorConfig TextEditorConfig { get; set; } = null!;
    [Inject]

...
public class WordAutocompleteService : IAutocompleteService
{
    ...
    public List<string> GetAutocompleteOptions(string word)
    {
		...
		// 	at DevIn.TextEditor.RazorLib.Autocompletes.Models.WordAutocompleteService.GetAutocompleteOptions(String word) in C:\Users\hunte\Repos\DevIn.Ide_Fork\Source\Lib\TextEditor\Autocompletes\Models\WordAutocompleteService.cs:line 14
		// 	at DevIn.TextEditor.RazorLib.TextEditors.Displays.Internals.AutocompleteMenu.GetMenuRecord()
		// 	at DevIn.TextEditor.RazorLib.TextEditors.Displays.Internals.AutocompleteMenu.<>c__DisplayClass33_0.<BuildRenderTree>b__1(RenderTreeBuilder __builder2)

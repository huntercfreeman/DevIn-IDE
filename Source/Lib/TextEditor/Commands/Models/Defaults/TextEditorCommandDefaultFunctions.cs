...
using DevIn.TextEditor.RazorLib.Events.Models;
...
namespace DevIn.TextEditor.RazorLib.Commands.Models.Defaults;
...
public class TextEditorCommandDefaultFunctions
{
    ...
    public static async ValueTask ShowTooltipByCursorPositionAsync(
        ...
        IDevInTextEditorComponentRenderers textEditorComponentRenderers)
    {
		...
		TextEditorComponentData componentData)
    {
        ...
        if (EventUtils.IsAutocompleteIndexerInvoker(keymapArgs))
        {
            ...
            catch (DevInTextEditorException e)
            {
                // Eat this exception
            }
        }
        ...
        TextEditorComponentData componentData)
    {
    	...
    	ShowDropdown(
	        ...
	        leftOffset: null,
	        topOffset: null,
	        typeof(DevIn.TextEditor.RazorLib.TextEditors.Displays.Internals.ContextMenu),
	        new Dictionary<string, object?>
			{
				{
					nameof(DevIn.TextEditor.RazorLib.TextEditors.Displays.Internals.ContextMenu.ComponentDataKey),
        ...
        TextEditorComponentData componentData)
    {
    	...
    	ShowDropdown(
	        ...
	        leftOffset: null,
	        topOffset: null,
	        typeof(DevIn.TextEditor.RazorLib.TextEditors.Displays.Internals.AutocompleteMenu),
	        new Dictionary<string, object?>
			{
				{
					nameof(DevIn.TextEditor.RazorLib.TextEditors.Displays.Internals.AutocompleteMenu.ComponentDataKey),
					componentData.ComponentDataKey
				},
			});
	}
	...
	public static async ValueTask ShowFindOverlay(
        ...
        TextEditorModel modelModifier,
        TextEditorViewModel viewModel,
        DevInCommonJavaScriptInteropApi commonJavaScriptInteropApi)
    {

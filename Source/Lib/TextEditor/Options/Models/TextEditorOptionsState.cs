    ...
    public TextEditorOptionsState()
    {
        Options = new TextEditorOptions(
            new CommonOptions(
                ...
                DevIn.Common.RazorLib.Options.Models.AppOptionsState.DEFAULT_RESIZE_HANDLE_WIDTH_IN_PIXELS,
                DevIn.Common.RazorLib.Options.Models.AppOptionsState.DEFAULT_RESIZE_HANDLE_HEIGHT_IN_PIXELS,

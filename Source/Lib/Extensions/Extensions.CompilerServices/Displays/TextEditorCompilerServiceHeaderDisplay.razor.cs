...
namespace DevIn.Extensions.CompilerServices.Displays;
    ...
    private void UpdateUi()
    {
    	...
    	TextEditorService.WorkerArbitrary.PostUnique(async editContext =>
    	{
			...
			if (presentationModel.PendingCalculation is null)
				throw new DevInTextEditorException($"{nameof(presentationModel)}.{nameof(presentationModel.PendingCalculation)} was not expected to be null here.");

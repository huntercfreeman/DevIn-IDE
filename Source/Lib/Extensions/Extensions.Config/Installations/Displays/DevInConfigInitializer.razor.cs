...
namespace DevIn.Extensions.Config.Installations.Displays;

public partial class DevInConfigInitializer : ComponentBase
{
    [Inject]
    ...
    public ValueTask Do_InitializeFooterJustifyEndComponents()
    {
        ...
        IdeMainLayoutService.RegisterFooterJustifyEndComponent(
            new FooterJustifyEndComponent(
                Key<FooterJustifyEndComponent>.NewKey(),
                typeof(DevIn.TextEditor.RazorLib.Edits.Displays.DirtyResourceUriInteractiveIconDisplay),
                new Dictionary<string, object?>
                {
                    {
                        nameof(DevIn.TextEditor.RazorLib.Edits.Displays.DirtyResourceUriInteractiveIconDisplay.CssStyleString),
                        "margin-right: 15px;"
                    }
                }));
        ...
        IdeMainLayoutService.RegisterFooterJustifyEndComponent(
            new FooterJustifyEndComponent(
                Key<FooterJustifyEndComponent>.NewKey(),
                typeof(DevIn.Common.RazorLib.Notifications.Displays.NotificationsInteractiveIconDisplay),

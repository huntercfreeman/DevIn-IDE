...
using DevIn.Common.RazorLib.ListExtensions;
...
using DevIn.TextEditor.RazorLib.BackgroundTasks.Models;
using DevIn.CompilerServices.DotNetSolution.Models.Project;
using DevIn.CompilerServices.DotNetSolution.Models;
using DevIn.CompilerServices.DotNetSolution.SyntaxActors;
...
// FindAllReferences
// using DevIn.Ide.RazorLib.FindAllReferences.Models;
using DevIn.Extensions.DotNet.AppDatas.Models;
...
public class DotNetBackgroundTaskApi : IBackgroundTaskGroup
{
    ...
    public ValueTask Do_DevInExtensionsDotNetInitializerOnInit()
    {
        InitializePanelTabs();
    ...
    public ValueTask Do_DevInExtensionsDotNetInitializerOnAfterRender()
    {
		...
		{
			cSharpCompilerService.SetSymbolRendererType(typeof(DevIn.Extensions.DotNet.TextEditors.Displays.CSharpSymbolDisplay));
		}*/

        _textEditorHeaderRegistry.UpsertHeader("cs", typeof(DevIn.Extensions.CompilerServices.Displays.TextEditorCompilerServiceHeaderDisplay));
    ...
    public ValueTask HandleEvent()
    {
        ...
        switch (workArgs.WorkKind)
        {
            ...
            case DotNetBackgroundTaskApiWorkKind.DevInExtensionsDotNetInitializerOnInit:
                return Do_DevInExtensionsDotNetInitializerOnInit();
            case DotNetBackgroundTaskApiWorkKind.DevInExtensionsDotNetInitializerOnAfterRender:
                return Do_DevInExtensionsDotNetInitializerOnAfterRender();

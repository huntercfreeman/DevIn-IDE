...
using DevIn.CompilerServices.Css.SyntaxActors;
...
public sealed class CssCompilerService : ICompilerService
{
    ...
    public void RegisterResource(ResourceUri resourceUri, bool shouldTriggerResourceWasModified)
    {
    	lock (_resourceMapLock)
        {
            ...
            _resourceMap.Add(resourceUri, new CssResource(resourceUri, this));
        }
    ...
    {
    	var lexer = new TextEditorCssLexer(modelModifier.PersistentState.ResourceUri, modelModifier.GetAllText());
    	lexer.Lex();

...
namespace DevIn.CompilerServices.CSharp.RuntimeAssemblies;
...
///          as if the source code itself were passed to the <see cref="DevIn.CompilerServices.CSharp.ParserCase.CSharpParser"/><br/><br/>
///

...
using DevIn.CompilerServices.Xml.Html;
using DevIn.CompilerServices.Xml.Html.Decoration;
using DevIn.CompilerServices.Xml.Html.Facts;
...
public class RazorSyntaxTree
{
        ...
        string matchedOn)
    {
        ...
        switch (matchedOn)
        {
            ...
            case RazorKeywords.NAMESPACE_KEYWORD:
                {
                    // @namespace DevIn.TextEditor.Demo.ServerSide.Pages
                    break;
                }
        ...
        int offsetPositionIndex)
    {
        ...
        foreach (var lexedTokenTextSpan in lexerOutput.SyntaxTokenList.Select(x => x.TextSpan).Union(lexerOutput.MiscTextSpanList))
        {
            ...
            var endingIndexExclusive = lexedTokenTextSpan.EndExclusiveIndex +
                                       offsetPositionIndex -
                                       adhocTemplateOpeningLength;
